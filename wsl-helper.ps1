...
function PaintMenu {
	do {
		$menuSelection = -1
		Write-Host "===================================="
		Write-Host "1. Install WSLv2"
		Write-Host "2. Expand WSLv2 Virtual Hard Disk"
		Write-Host "3. Compact WSLv2 Virtual Hard Disk"
		Write-Host "4. Install WSLv2 Distribution"
		Write-Host "5. Exit"
		Write-Host "===================================="
		$menuSelection = Read-Host  -Prompt "Selection: "
		
	} while($menuSelection -le 0) 
}
